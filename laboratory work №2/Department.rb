...
4. Создать объект класса Department, добавить, изменить, удалить несколько обязанностей,
...
5. Добавить метод КЛАССА, проверяющий, является ли некоторая строка телефонным номером.
